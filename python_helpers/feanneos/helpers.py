...
def helper_jitted_funs(model: HelmholtzModel, params: Any):
    ...
    second_virial_coefficient_fun = jax.jit(lambda alpha, Tad:
                                            model.second_virial_coefficient(params,
                                                                            jnp.atleast_1d(alpha),
                                                                            jnp.atleast_1d(Tad)))

    third_virial_coefficient_fun = jax.jit(lambda alpha, Tad:
                                           model.third_virial_coefficient(params,
                                                                          jnp.atleast_1d(alpha),
                                                                          jnp.atleast_1d(Tad)))

    virial_coefficients_fun = jax.jit(lambda alpha, Tad:
                                     model.virial_coefficients(params,
                                                              jnp.atleast_1d(alpha),
                                                              jnp.atleast_1d(Tad)))
    ...
    # compiling virial functions
    second_virial_coefficient_fun(ones_input[0], ones_input[2])
    third_virial_coefficient_fun(ones_input[0], ones_input[2])
    virial_coefficients_fun(ones_input[0], ones_input[2])
    ...
    funs_dict = {'helmholtz_fun': helmholtz_fun,
                 ...
                 'second_virial_coefficient_fun': second_virial_coefficient_fun,
                 'third_virial_coefficient_fun': third_virial_coefficient_fun,
                 'virial_coefficients_fun': virial_coefficients_fun}
    return funs_dict
