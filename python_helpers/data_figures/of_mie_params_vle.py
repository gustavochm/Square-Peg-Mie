...
def values_vle_model(inc, expdata_exel, fun_dic, interpd_dict, lambda_a=6.):
...
def mie_params_of_vle(inc, DataFile, fun_dic, interpd_dict,
                      lambda_a=6.,
                      weight_rhov_vle=1., weight_hvap=1., add_critical_point=True,
                      loss_function=np.nanmean):

    values = values_vle_model(inc, DataFile, fun_dic, interpd_dict, lambda_a=lambda_a)
