...
def values_vle_sle_sve_visc_model(inc, DataFile, fun_dic, visc_fun, interpd_dict, lambda_a=6.):
    ...
    values['tcond_factor'] = tcond_factor
    values['visc_factor'] = visc_factor
    values['diff_factor'] = diff_factor
    ...
    # saving extra values neded to compare other properties
    values['Mw'] = Mw
    values['speed_of_sound_vle_exp'] = speed_of_sound_vle
    values['thermal_conductivity_vle_exp'] = thermal_conductivity_vle
    return values


def mie_params_of_vle_sle_sve_visc(inc, DataFile, fun_dic, visc_fun, interpd_dict, 
                                   lambda_a=6., 
                                   weight_rhov_vle=1.,  
    ...
    values = values_vle_sle_sve_visc_model(inc, DataFile, fun_dic, visc_fun, interpd_dict, lambda_a=lambda_a)
